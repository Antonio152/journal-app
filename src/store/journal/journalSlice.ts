...
export const journalSlice = createSlice({
  ...
  reducers: {
    ...
    removeImageFromArray: (state, action: PayloadAction<number>) => {
      state.filesUploadImg = state.filesUploadImg.filter(
    ...
    /* Screen variant */
    setVariantScreen: (state,action: PayloadAction<string>) => {
      state.variantScreen = action.payload;
    }
  }
});
